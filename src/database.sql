...
CREATE DATABASE IF NOT EXISTS scoutpro;
USE scoutpro;
...
INSERT INTO meio_stats (jogador_id, assistencias, passes_certos, passes_tentados, desarmes, interceptacoes)
VALUES
(10, 3, 800, 950, 40, 35),
(11, 4, 1200, 1350, 55, 48),
(12, 2, 700, 900, 30, 25),
(13, 6, 1500, 1700, 45, 30),
(14, 1, 300, 400, 15, 10),
(20, 2, 250, 320, 12, 8),
(22, 1, 200, 280, 10, 7);
...
SELECT 
    ...
    m.interceptacoes
FROM jogadores j
JOIN meio_stats m ON j.id = m.jogador_id
WHERE j.posicao = 'MEI';
