...
public class TelaPrincipal extends javax.swing.JPanel {
    ...
    private void ordenarAtacantes(java.util.List<Atacante> lista, FiltroB filtro) {
        ...
        java.util.Comparator<Atacante> comparador = switch (filtro.getColunaOrdenacao()) {
            ...
            case "dribles_certos" ->
                java.util.Comparator.comparingInt(Atacante::getDriblesCertos);
    ...
    private void ordenarGoleiros(java.util.List<Goleiro> lista, FiltroB filtro) {
        ...
        java.util.Comparator<Goleiro> comparador = switch (filtro.getColunaOrdenacao()) {
            case "clean_sheets" ->
            ...
            case "pct_defesas" ->
                java.util.Comparator.comparingDouble(Goleiro::calcularPorcentagemDefesas);
            case "defesas_dificeis_90" ->
                java.util.Comparator.comparingDouble(Goleiro::calcularDefesasDificeisPor90);
...
// Aplica a filtragem em memória com a classe FiltroC
                lista = FiltroC.aplicarFiltro(lista, filtroAtual);
                ordenarGoleiros(lista, filtroAtual); // <-- adicionar esta linha
