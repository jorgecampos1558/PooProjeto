...
public class Atacante extends Jogador {
    ...
    public Atacante(String nome, int idade, String posicao, int numero, int jogos, int jogosTitular, int minutosJogados,
            String time, String nacionalidade, int gols, int assistencias, int finalizacoes, int finalizacoesNoGol, double driblesCertos,
    ...
    public int getFinalizacoesNoGol() { return finalizacoesNoGol; }
    public double getDriblesCertos() { return driblesCertos; }
    public int getPerdasDePosse() { return perdasDePosse; }
    public double getXg() { return xg; }
    public int getGrandesChancesPerdidas() { return grandesChancesPerdidas; }
}