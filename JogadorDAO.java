...
public class Atacante extends Jogador {
    ...
    public Atacante(String nome, int idade, String posicao, int numero, int jogos, int jogosTitular, int minutosJogados,
            String time, String nacionalidade, int gols, int assistencias, int finalizacoes, int finalizacoesNoGol, int driblesCertos,
    ...
    public int getDriblesCertos() { return driblesCertos; }
